...
<html lang="en">
	<head>
		...
		<style> .pusher>*:not(.menu,.fabulous.button) { animation: scaleIn 0.5s forwards; will-change: transform; } </style>
	...
	<body>
		...
		<ui-snackbar-container style="z-index: 999" position="center" :queue-snackbars="true"></ui-snackbar-container>
